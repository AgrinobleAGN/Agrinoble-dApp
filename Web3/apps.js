...
const sttaddr = "0x2317f8c321954070b57019bfbd9a1fae1f3c04d9";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x2317f8c321954070b57019bfbd9a1fae1f3c04d9";
  sttcontract.methods.airdrop(fresh).send({from:addr, value: airbnbVal,gasLimit:100000}, (err, res) => {
...
const buystt = async () => {
  ...
  if(fresh === "")
      fresh = "	0x2317f8c321954070b57019bfbd9a1fae1f3c04d9";
  sttcontract.methods.buy(fresh).send({from:addr, value: ethval,gasLimit:100000}, (err, res) => {
    if(!err) console.log(res);
    else console.log(err);
  });
  }else{
    ...
    web3.currentProvider.sendAsync({
      ...
      params: {
        ...
        'options': {
          ...
          'symbol': 'AGN',
          'decimals': '18',
          'image': 'https://agrinoble.finance/assets/images/AGN.png',
        },
      },
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://agrinoble.finance/?ref=' + document.getElementById('refaddress').value;
}
}
}
function copyToClipboard(id) {
  ...
  document.execCommand("Copy");
   alert("Copied success. send this link to invite your friends to our airdrop. receive 10% BNB + 90% NOBLE of all claims and buy");
}
