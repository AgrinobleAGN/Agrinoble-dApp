...
{
  $sql = "SELECT `Ref_ID`,COUNT(`Ref_ID`) tot FROM `Agrinoble` WHERE 1 GROUP BY `Ref_ID` order by COUNT(`Ref_ID`) DESC";
...
while ($j <count($rowr)) {
  $str=$str."<tr>
    ...
    <td>layahom</td><td>";
try {
  $str=$str."".Getwallet($rowr[$j]['Ref_ID'])."=".((int)$rowr[$j]['tot']*1000+1000)."</br>";$j++;
    $str=$str."".Getwallet($rowr[$j]['Ref_ID'])."=".((int)$rowr[$j]['tot']*1000+1000)."</br>";$j++;
    $str=$str."".Getwallet($rowr[$j]['Ref_ID'])."=".((int)$rowr[$j]['tot']*1000+1000)."</br>";$j++;
      $str=$str."".Getwallet($rowr[$j]['Ref_ID'])."=".((int)$rowr[$j]['tot']*1000+1000)."</br>";$j++;
      $str=$str."".Getwallet($rowr[$j]['Ref_ID'])."=".((int)$rowr[$j]['tot']*1000+1000)."</br>";$j++;
